DApp Link:  https://solana-referral-d-app-4ktj.vercel.app?ref=HQpcApEUAMdJNcQ3HGmnzzWNpjJf1DGuAbXXTMXRdX4n
...
```bash
git clone https://github.com/SecureChainAI/Referral-Dapp-Solana
cd Referral-Dapp-Solana
```
